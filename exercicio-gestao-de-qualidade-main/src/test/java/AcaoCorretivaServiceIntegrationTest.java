...
public class AcaoCorretivaServiceIntegrationTest {
    ...
    private static final String SQL_TRUNCATE1 =
            """
            DROP TABLE Equipamento;
            """;

    private static final String SQL_TRUNCATE2 =
            """
            DROP TABLE Falha;
            """;

    private static final String SQL_TRUNCATE3 =
            """
            DROP TABLE AcaoCorretiva;
            """;
    ...
    void setupEach() throws Exception {
        try (Connection conn = Conexao.conectar();
            ...
            stmt.execute(SQL_TRUNCATE1);
            stmt.execute(SQL_TRUNCATE2);
            stmt.execute(SQL_TRUNCATE3);
        }
